...
func (in *Certificates) DeepCopyInto(out *Certificates) {
	*out = *in
	if in.ExternalCertificates != nil {
		in, out := &in.ExternalCertificates, &out.ExternalCertificates
		*out = new(ExternalCertificates)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrdbClusterRegion) DeepCopyInto(out *CrdbClusterRegion) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrdbClusterRegion.
func (in *CrdbClusterRegion) DeepCopy() *CrdbClusterRegion {
	if in == nil {
		return nil
	}
	out := new(CrdbClusterRegion)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CrdbClusterSpec) DeepCopyInto(out *CrdbClusterSpec) {
	*out = *in
	...
	if in.Regions != nil {
		...
		*out = make([]CrdbClusterRegion, len(*in))
		copy(*out, *in)
	}
	if in.RollingRestartDelay != nil {
		in, out := &in.RollingRestartDelay, &out.RollingRestartDelay
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrdbNode) DeepCopyInto(out *CrdbNode) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrdbNode.
func (in *CrdbNode) DeepCopy() *CrdbNode {
	if in == nil {
		return nil
	}
	out := new(CrdbNode)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *CrdbNode) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrdbNodeList) DeepCopyInto(out *CrdbNodeList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]CrdbNode, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrdbNodeList.
func (in *CrdbNodeList) DeepCopy() *CrdbNodeList {
	if in == nil {
		return nil
	}
	out := new(CrdbNodeList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *CrdbNodeList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrdbNodeSpec) DeepCopyInto(out *CrdbNodeSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrdbNodeSpec.
func (in *CrdbNodeSpec) DeepCopy() *CrdbNodeSpec {
	if in == nil {
		return nil
	}
	out := new(CrdbNodeSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrdbNodeStatus) DeepCopyInto(out *CrdbNodeStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrdbNodeStatus.
func (in *CrdbNodeStatus) DeepCopy() *CrdbNodeStatus {
	if in == nil {
		return nil
	}
	out := new(CrdbNodeStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CrdbNodeTemplate) DeepCopyInto(out *CrdbNodeTemplate) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CrdbNodeTemplate.
func (in *CrdbNodeTemplate) DeepCopy() *CrdbNodeTemplate {
	if in == nil {
		return nil
	}
	out := new(CrdbNodeTemplate)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalCertificates) DeepCopyInto(out *ExternalCertificates) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalCertificates.
func (in *ExternalCertificates) DeepCopy() *ExternalCertificates {
	if in == nil {
		return nil
	}
	out := new(ExternalCertificates)

...
func TestGenerateFiles(t *testing.T) {
	...
	tests := []struct {
		...
		{version: "2.1.0", args: []string{"release/gen-files", "CHANNEL=stable", "IS_DEFAULT_CHANNEL=1"}},
		{version: "2.1.0-beta.1", args: []string{"release/gen-files", "CHANNEL=beta", "IS_DEFAULT_CHANNEL=0"}},
	}

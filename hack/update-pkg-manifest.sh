...
SUPPORTED_VERSIONS=(v19.2.12 v20.1.11 v20.1.12 v20.1.13 v20.1.14 v20.1.15 v20.1.16 v20.1.4 v20.1.5 v20.1.8 v20.2.0 v20.2.1 v20.2.2 v20.2.3 v20.2.4 v20.2.5 v20.2.6 v20.2.7 v20.2.8 v20.2.9 v20.2.10 v21.1.0)
...
do
  ...
  sed -i '' -e "s+${ENV_VAR_PLACEHOLDER}+${RH_COCKROACH_DATABASE_IMAGE_VERSION}+g" ${DEPLOY_PATH}/${RH_BUNDLE_VERSION}/csv.yaml
done

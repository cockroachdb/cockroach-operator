...
RH_BUNDLE_VERSION?=1.2.3
RH_DEPLOY_PATH="deploy/certified-metadata-bundle"
RH_DEPLOY_FULL_PATH="$(RH_DEPLOY_PATH)/cockroach-operator/"
RH_COCKROACH_DATABASE_IMAGE=registry.connect.redhat.com/cockroachdb/cockroach:v20.1.12
RH_OPERATOR_IMAGE?=us.gcr.io/chris-love-operator-playground/cockroachdb-operator:v1.8.37
